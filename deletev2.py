        ...
        if here["is_folder"]:
            ...
            for x in dirs:
                for y in x["list_child"]:
                    print("Child path:", y["dir_path"], "\n")
                    print("Child name:", y["file_name"], "\n")
                    print("Child parent:", y["parent_dir"], "\n")
                    print("Child size:", y["data_totalsize"], "\n")
                    print("Child start:", y["data_start"], "\n")

        currsec = input("Enter number:")
        currsec = int(currsec)
